  ...
  data() {
    return {
      ...
      rateList: [
        ...
        {
          photo:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROnw8KD3eY1x5_si1vNJwQ8JdZxT2R5Bpy4w&usqp=CAU",
          name: "咨询师E",
          averageScore: 4.4,
        },
      ],
